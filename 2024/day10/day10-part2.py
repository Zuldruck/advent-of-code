...
def get_trailhead_score(pos, previous_pos):
    ...
    for direction in directions:
        ...
        if nextCellHeight == cellHeight + 1:
            score += get_trailhead_score((pos[0] + directions[direction][0], pos[1] + directions[direction][1]), pos)
    return score
